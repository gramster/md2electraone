...
| CC (Hex) | Target           | Range | List/Pad Choices (and possibly values)                                                                                                                                         |
| -------- | ---------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 0x1A     | Chord Degree     | 1-7   | I, II, III, IV, V, VI, VII                                                                                                                                                     |
| 0x1B     | Chord Type       | 1-7   | Triad, 7th, sus2, alt1, alt2, sus4, 6th                                                                                                                                        |
| 0x59     | Load a Chord Seq | 1-5   |                                                                                                                                                                                |
| 0x45     | Chord Inversion  | 0-127 | On (0), Off (63)                                                                                                                                                               |
...
| 0x38     | KB Transpose     | 1-16  |                                                                                                                                                                                |
| 0x5A     | ALL Pause / Play | 0-127 | Pause (0), Play (63)                                                                                                                                                           |

# Drone

| **CC (Hex)** | **Target**   | **Range** | List/Pad Choices (and possibly values)        |
| ------------ | ------------ | --------- | --------------------------------------------- |
| 0x15         | MIDI Channel | 1-16      |                                               |
| 0x14         | MIDI Port    | 1-7       | All, USB 1, USB 2, USB 3, USB 4, DIN A, DIN B |
| 0x20         | Octave       | 1-5       |                                               |
| 0x21         | Notes        | 1-7       |                                               |
| 0x22         | Trigger      | 1-8       |                                               |
...
| **CC (Hex)** | **Target**   | **Range** | List/Pad Choices (and possibly values)        |
| ------------ | ------------ | --------- | --------------------------------------------- |
| 0x13         | MIDI Channel | 1-16      |                                               |
| 0x12         | MIDI Port    | 1-7       | All, USB 1, USB 2, USB 3, USB 4, DIN A, DIN B |
| 0x1C         | Position     | 1-100     |                                               |
...
| **CC (Hex)** | **Target**   | **Range** | List/Pad Choices (and possibly values)                     |
| ------------ | ------------ | --------- | ---------------------------------------------------------- |
| 0x17         | MIDI Channel | 1-16      |                                                            |
| 0x16         | MIDI Port    | 1-7       | All, USB 1, USB 2, USB 3, USB 4, DIN A, DIN B              |
| 0x23         | Octave       | 1-10      |                                                            |
...
| 0x2A         | Rhythm       | 1-40      |                                                            |
| 0x50         | Velocity     | 1-127     |                                                            |
| 0x53         | On/Off       | 0-127     | Off = 0-62, On = 63-127                                    |
# Motif 2


| **CC (Hex)** | **Target**   | **Range** | List/Pad Choices (and possibly values)                     |
| ------------ | ------------ | --------- | ---------------------------------------------------------- |
| 0x19         | MIDI Channel | 1-16      |                                                            |
| 0x18         | MIDI Port    | 1-7       | All, USB 1, USB 2, USB 3, USB 4, DIN A, DIN B              |
| 0x2B         | Octave       | 1-10      |                                                            |
