...
unpleasant ways when imported into the Electra One editor. I have seen
groups get their bounding boxes switched with other groups, and controls
drop off the end of a page. I have wrestled hard with these bugs but
am currently pretty stumped. At the very least the former behavior
by the Electra One editor seems positively wrong. I wish it provided
diagnostic output to help debug this, as I can use the exact same bounding
boxes as some other preset that loads fine, and mine will get messed up.
